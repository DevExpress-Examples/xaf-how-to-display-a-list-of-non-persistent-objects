<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/128589551/22.2.5%2B)
...
This example demonstrates how to display a list of non-persistent objects. 
