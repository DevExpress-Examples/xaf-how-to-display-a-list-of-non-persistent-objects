...
<!-- default badges end -->
# XAF - How to display a list of non-persistent objects

This example demonstrates how to display a list of non-persistent objects in an XAF application. 
  
<kbd>![image](https://user-images.githubusercontent.com/14300209/232475656-ba30a5be-4e96-49f9-8228-2091378e5f09.png)</kbd>

## Implementation Details

The complete description is available in the following help topic: [How to: Display a List of Non-Persistent Objects in a Popup Dialog](https://docs.devexpress.com/eXpressAppFramework/113167/business-model-design-orm/non-persistent-objects/how-to-display-a-list-of-non-persistent-objects-in-a-popup-dialog).
